...
urlpatterns = [
    ...
    url(r'^$', cache_page(60*60)(views.view_index), name='view_PHL_index'),
    ### link to create production history log item
    url(r'^production$', cache_page(60*60)(views.view_phl_form), name='view_phl_form'),
    ### link to view specific production history log
    url(r'^production/(?P<jobNo>[0-9]+(.[0-9]+)+)$', cache_page(60*60)(views.view_specific_phl_form), name='view_specific_phl_form'),
    ### link to create mold history log item
    url(r'^mold$', cache_page(60*60)(views.view_mold_form), name='view_mold_form'),
    ### link to view specific mold history log
    url(r'^mold/(?P<moldNo>[0-9]+(.[0-9]+)+)$', cache_page(60*60)(views.view_specific_mold_form), name='view_specific_mold_form'),
    ...
    url(r'^mold_maintence_request/$', cache_page(60*60)(views.view_tooling_requests), name='view_tooling_requests'),
    ### link to view specific production history log
